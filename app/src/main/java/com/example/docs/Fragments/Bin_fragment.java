...
public class Bin_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bin_fragment,container,false);
        recyclerView = view.findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new GridLayoutManager(Bin_fragment.this.getContext()
                ,2));
        return view;
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.gridMenu:
                ...
                return true;
            case R.id.listMenu:
                recyclerView.setLayoutManager(new LinearLayoutManager(Bin_fragment.this.getContext()));
                return true;
    ...
    void getData()
    {
        myCollection.whereEqualTo("onBin",true)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@javax.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @javax.annotation.Nullable FirebaseFirestoreException e) {
                        if (e!=null)
                        {
                            ...
                            adapter = new RecyclerAdapter(Bin_fragment.this.getContext(),myList);
